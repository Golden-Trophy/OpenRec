    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "RoomTopia Intro";
                Console.WriteLine("Welcome to RoomTopia " + appversion + "!");
                Console.WriteLine("Is this your first time using RoomTopia?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "RoomTopia Tutorial";
                    Console.WriteLine("In that case, welcome to RoomTopia!");
        ...
        Start:
            Console.Title = "RoomTopia Startup Menu";
            Console.ForegroundColor = ConsoleColor.Green;
            ...
            if (readline == "2")
            {
                ...
                Settings:
                Console.Title = "RoomTopia Settings Menu";
                ...
                {
                    Console.Title = "RoomTopia Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                Console.Title = "RoomTopia Profile Menu";
                ...
                else if (readline3 == "2")
                {
                    ...
                    else if (readline4 == "2")
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("Invalid Image (Make sure its on the same drive as RoomTopia)");
                            goto Profile;
                        }
                        Console.Clear();
                        Console.WriteLine("Success!");
                ...
                {
                    Console.Title = "RoomTopia Profile Downloader";
                    Console.Clear();
                    Console.WriteLine("Profile Downloader: This tool takes the username and profile image of any username you type in and imports it to RoomTopia.");
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "RoomTopia October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "RoomTopia May 30th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RoomTopia September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "RoomTopia July 20th 2018";
                        version = "2018";
                        Console.Clear();
